...
class OnBuildCommand(sublime_plugin.WindowCommand):
	def run(self, **args):
		...
		if platform == 'windows' and arch == "x64":
			cmd = ["C:\\Program Files (x86)\\Corona Labs\\Corona SDK\\Corona Simulator.exe", "/singleton", "/no-console", cmd[1]]
		elif platform == 'windows':
			cmd = ["C:\\Program Files\\Corona Labs\\Corona SDK\\Corona Simulator.exe", "-singleton", "/no-console", cmd[1]]
		#elif platform == 'osx':
